...
% pz1=r>1;
% TrnAug=36;
% TrnData_ImgCell =cell(TrnSize*TrnAug,1);
% TrnLabels=zeros(TrnSize*TrnAug,1);
% for i=1:1:TrnSize
%     for j=0:1:TrnAug-1
...
%     end
% end
%% CASE3: training with rotation and noisy images
% training
[r,o]=ro(ImgSize,ImgSize);
pz1=r>1;
TrnAug=48;
...
for i=1:1:TrnSize
    for j=0:1:35
        ...
        NI(pz1)=0;
%         NI=denoiseImage(NI,net);  % with denoising
        k=(i-1)*36+j+1;
...
% The pre-trained models of PCANet are too large to be uploaded to Github.
% You can use the above training code to get the same models, but it takes more time.
% Please feel free to contact me to get these models directly.
...
%% Load pre-trained models for CASE3 %%
% The pre-trained models of PCANet are too large to be uploaded to Github.
% You can use the above training code to get the same models, but it takes more time.
% Please feel free to contact me to get these models directly.
